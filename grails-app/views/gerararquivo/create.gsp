...
<html>
    ...
    <body style="background-image:url(${createLinkTo(dir:'images/view/create/backgroundPagina',file:'backgroundPagina.jpg')});background-repeat:no-repeat;background-size:cover;">
        ...
        <div class="body">
            ...
            <g:form action="selecionartabelas">
                <div class="dialog">
                    <table>
                        <tbody>
	            ...
	            <div class="buttons" align="center">
					...
					<% if(tabelas){ %><span class=""><input  class="btn waves-effect waves-light" style="background-image:url(${createLinkTo(dir:'images/view/create/botao',file:'botao.jpg')});padding:10px;margin:10px;size:30px;width:110px;" type="submit" value="Resetar"/></span><% } %> 
                </div><br>
